...
const (
	...
	//
	//CLEARING_MARKET indicates that we're accepting orders, and fully clearing
	//the market for this duration.
	DurationBucketState_CLEARING_MARKET DurationBucketState = 3
)
...
type OrderMatchPrepare struct {
	...
	MatchedMarkets map[uint32]*MatchedMarket `protobuf:"bytes,1,rep,name=matched_markets,json=matchedMarkets,proto3" json:"matched_markets,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	//
	...
	//units (sat/kW).
	FeeRateSatPerKw uint64 `protobuf:"varint,5,opt,name=fee_rate_sat_per_kw,json=feeRateSatPerKw,proto3" json:"fee_rate_sat_per_kw,omitempty"`
	//
	//Fee rebate in satoshis, offered if another batch participant wants to pay
	//more fees for a faster confirmation.
	FeeRebateSat uint64 `protobuf:"varint,6,opt,name=fee_rebate_sat,json=feeRebateSat,proto3" json:"fee_rebate_sat,omitempty"`
	//
	...
	BatchVersion         uint32   `protobuf:"varint,8,opt,name=batch_version,json=batchVersion,proto3" json:"batch_version,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type TermsResponse struct {
	...
	LeaseDurationBuckets map[uint32]DurationBucketState `protobuf:"bytes,4,rep,name=lease_duration_buckets,json=leaseDurationBuckets,proto3" json:"lease_duration_buckets,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=poolrpc.DurationBucketState"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}
...
type RelevantBatch struct {
	...
	//Maps the distinct lease duration markets to the orders that were matched
	//within and the discovered market clearing price.
	MatchedMarkets map[uint32]*MatchedMarket `protobuf:"bytes,4,rep,name=matched_markets,json=matchedMarkets,proto3" json:"matched_markets,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// The fee parameters used to calculate the execution fees.
	ExecutionFee *ExecutionFee `protobuf:"bytes,5,opt,name=execution_fee,json=executionFee,proto3" json:"execution_fee,omitempty"`
	...
	//Fee rate of the batch transaction, expressed in satoshis per 1000 weight
	//units (sat/kW).
	FeeRateSatPerKw      uint64   `protobuf:"varint,7,opt,name=fee_rate_sat_per_kw,json=feeRateSatPerKw,proto3" json:"fee_rate_sat_per_kw,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type BatchSnapshotResponse struct {
	...
	//Maps the distinct lease duration markets to the orders that were matched
	//within and the discovered market clearing price.
	MatchedMarkets map[uint32]*MatchedMarketSnapshot `protobuf:"bytes,4,rep,name=matched_markets,json=matchedMarkets,proto3" json:"matched_markets,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// The txid of the batch transaction.
	BatchTxId string `protobuf:"bytes,5,opt,name=batch_tx_id,json=batchTxId,proto3" json:"batch_tx_id,omitempty"`
	// The batch transaction including all witness data.
...
var fileDescriptor_f3883418d94ca37f = []byte{
	...
	,
}
