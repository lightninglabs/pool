...
multi-sig output between two parties $A$ and $B$. One, or both parties deposit
...
a payment \emph{sink}, in that it is primarily \emph{receiving} over the LN. In
theory, it's possible for a service to be balanced in terms of sending
...
\begin{definition}{(Liquidity Taker).} % call Lease instead? also define CLM earlier in the process? 
    ...
    period of at least $T_{block}$ Bitcoin blocks. 
\end{definition}
